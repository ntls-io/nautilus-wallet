...
import { SessionStore } from 'src/app/stores/session/index';
import { defined, panic } from 'src/app/utils/errors/panic';
import { never } from 'src/helpers/helpers';
import { AlgorandTransactionSigned } from 'src/schema/entities';

/**
 * This service coordinates interaction between the store and Algorand ledger.
 *
 * - {@link SessionStore}
 * - {@link EnclaveService}
 * - {@link AlgodService}
...
export class WalletAlgorandService {
  constructor(
