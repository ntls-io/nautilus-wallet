...
/* harmony export */ });
/* harmony import */ var _index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-b3eecb14.js */ 66931);
/* harmony import */ var _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./haptic-683b3b3c.js */ 93067);
/* harmony import */ var _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-3f1a7d95.js */ 87610);
/*!
...
/* harmony import */ var _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers-4d272360.js */ 33318);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
/* harmony import */ var _Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 74475);
/* harmony import */ var _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers-4d272360.js */ 33318);
/* harmony import */ var _index_9ac92660_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-9ac92660.js */ 74468);
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/* harmony export */ });
/* harmony import */ var _helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers-4d272360.js */ 33318);
/* harmony import */ var _dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dir-e8b767a8.js */ 77106);
/* harmony import */ var _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-3f1a7d95.js */ 87610);
/* harmony import */ var _gesture_controller_17e82006_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./gesture-controller-17e82006.js */ 24007);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
...
/***/ 46134:
/*!****************************************!*\
  !*** ./src/app/utils/toast.helpers.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const showToast = /*#__PURE__*/function () {
  var _ref = (0,_Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (toastController, message, opts) {
    const toast = yield toastController.create(Object.assign({
      message
    }, opts));
    yield toast.present();
    return toast;
  ...
  return function showToast(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
/***/ 91327:
/*!*************************************************************!*\
  !*** ./src/app/views/manual-address/manual-address.page.ts ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ManualAddressPage": () => (/* binding */ ManualAddressPage)
/* harmony export */ });
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ 31777);
/* harmony import */ var src_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/helpers/helpers */ 42289);
...
function ManualAddressPage_p_15_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "p", 14);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, " This address is not valid ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
class ManualAddressPage {
    constructor(modalCtrl) {
        this.modalCtrl = modalCtrl;
        this.addressForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroup({
            address: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl('', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required, addressValidator]),
        });
    }
    ngOnInit() { }
    dismiss(success, address) {
    ...
    onSubmit() {
        ...
        if (this.addressForm.valid) {
            const formControl = (0,src_helpers_helpers__WEBPACK_IMPORTED_MODULE_0__.checkClass)(this.addressForm.controls.address, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl);
            const address = trimmedValue(formControl);
            this.dismiss(true, address);
        }
    }
}
ManualAddressPage.ɵfac = function ManualAddressPage_Factory(t) { return new (t || ManualAddressPage)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_3__.ModalController)); };
ManualAddressPage.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ManualAddressPage, selectors: [["app-manual-address"]], decls: 18, vars: 2, consts: [[1, "ion-no-border"], ["fixed", ""], ["slot", "start"], [3, "click"], ["slot", "icon-only", "name", "close-circle-outline"], [1, "ion-text-center"], [1, "h-full", "ion-justify-content-center", "px-5"], [1, "ion-align-self-center"], ["name", "wallet-outline", 1, "!text-5xl"], [1, "font-semibold", "font-nasalization"], [3, "formGroup", "ngSubmit"], ["type", "text", "placeholder", "Enter recipient's wallet address", "formControlName", "address", 1, "p-0"], ["class", "text-danger text-sm", 4, "ngIf"], ["expand", "block", "shape", "round", "type", "submit", 1, "mt-4"], [1, "text-danger", "text-sm"]], template: function ManualAddressPage_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-header", 0)(1, "ion-grid", 1)(2, "ion-toolbar")(3, "ion-buttons", 2)(4, "ion-button", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ManualAddressPage_Template_ion_button_click_4_listener() { return ctx.dismiss(false); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](5, "ion-icon", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()()()()();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](6, "ion-content", 5)(7, "ion-grid", 1)(8, "ion-row", 6)(9, "ion-col", 7);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](12, "Wallet address");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](13, "form", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function ManualAddressPage_Template_form_ngSubmit_13_listener() { return ctx.onSubmit(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](14, "ion-textarea", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](15, ManualAddressPage_p_15_Template, 2, 0, "p", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](16, "ion-button", 13);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](17, " Confirm ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]()()()()()();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](13);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("formGroup", ctx.addressForm);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", !(ctx.addressForm == null ? null : ctx.addressForm.pristine) && (ctx.addressForm.errors == null ? null : ctx.addressForm.errors.invalidAddress));
    } }, directives: [_ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonHeader, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonGrid, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonToolbar, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonButtons, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonButton, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonIcon, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonContent, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonRow, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonCol, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ɵNgNoValidate"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__.NgControlStatusGroup, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroupDirective, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.IonTextarea, _ionic_angular__WEBPACK_IMPORTED_MODULE_3__.TextValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControlName, _angular_common__WEBPACK_IMPORTED_MODULE_4__.NgIf], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJtYW51YWwtYWRkcmVzcy5wYWdlLnNjc3MifQ== */"] });
const addressValidator = (formGroup) => {
    const address = trimmedValue(formGroup);
    return address ? null : { invalidAddress: true };
};
const trimmedValue = (formControl) => {
...
/***/ 52347:
/*!******************************************!*\
  !*** ./src/app/views/scanner.helpers.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "handleScan": () => (/* binding */ handleScan)
/* harmony export */ });
/* harmony import */ var _Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 74475);
/* harmony import */ var _helpers_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../helpers/helpers */ 42289);
/* harmony import */ var _scanner_scanner_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scanner/scanner.page */ 48574);



const handleScan = /*#__PURE__*/function () {
  var _ref = (0,_Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (modalCtrl, swal, scanSuccess) {
    // FIXME: fix import for OverlayEventDetail
    // const dismissed = async (eventDetail: { data?: ScanResult }) => {
    const dismissed = /*#__PURE__*/function () {
      var _ref2 = (0,_Users_jongbonga_Code_Ntls_Wallet_web_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (eventDetail) {
        const {
          data: result
        } = eventDetail;
        ...
        switch (result === null || result === void 0 ? void 0 : result.type) {
          case 'scanSuccess':
            yield scanSuccess(result.result);
            break;
          ...
          default:
            (0,_helpers_helpers__WEBPACK_IMPORTED_MODULE_1__.never)(result);
        }
      });

      return function dismissed(_x4) {
        return _ref2.apply(this, arguments);
      };
    }(); // Show modal


    const scanner = yield modalCtrl.create({
      component: _scanner_scanner_page__WEBPACK_IMPORTED_MODULE_2__.ScannerPage
    });
    const didDismissPromise = scanner.onDidDismiss();
    yield scanner.present();
    yield dismissed(yield didDismissPromise);
  });

  return function handleScan(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
